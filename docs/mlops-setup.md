...
git add README.md docs .gitignore zulfikar_mlops_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[zulfikar_mlops_project/databricks.yml](../zulfikar_mlops_project/databricks.yml) file.
...
Follow the instructions in [zulfikar_mlops_project/resources/README.md](../zulfikar_mlops_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../zulfikar_mlops_project/resources/README.md)  to propose, test, and deploy
