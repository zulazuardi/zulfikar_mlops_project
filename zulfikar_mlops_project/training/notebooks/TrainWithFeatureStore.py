...
# ``zulfikar_mlops_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-zulfikar_mlops_project-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.zulfikar_mlops_project.zulfikar_mlops_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.zulfikar_mlops_project.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.zulfikar_mlops_project.trip_dropoff_features",
